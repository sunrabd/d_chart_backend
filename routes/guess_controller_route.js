...
// Get all AddGuesses
router.post('/add-guess/get',authenticateToken,addGuessController.getAllAddGuesses);

// Get AddGuess by id,  market_type,  or game_type
router.post('/add-guess/:id',authenticateToken,addGuessController.getAddGuessByIdAndTypes);
